"""PyQtGraph waveform charts for the WiParse scope tool."""
...
def attach_waveform_charts(ui) -> None:
    ...
    ui.line_specs = [
        (ui.line_power, CHART_POWER, 2.2),
        (ui.line_v_in, CHART_VOLTAGE, 2.2),
        (ui.line_i_in, CHART_CURRENT, 2.0),
        (ui.line_v_out, CHART_VOLTAGE, 2.2),
        (ui.line_i_out, CHART_CURRENT, 2.0),
        (ui.line_v_bat, CHART_VOLTAGE, 2.2),
        (ui.line_i_bat, CHART_CURRENT, 2.0),
    ]
