...
STRINGS: dict[str, tuple[str, str]] = {
    'app.title': ('PC 综合工具', 'PC Utility Suite'),
    'status.ready': ('就绪', 'Ready'),
    'menu.view': ('视图(&V)', '&View'),
    'menu.serial_tool': ('串口工具', 'Serial Tool'),
    'menu.waveform_scope': ('示波器工具', 'Scope Tool'),
    'menu.tektronix_scope': ('泰克示波器', 'Tektronix Scope'),
    ...
    'tool.tektronix_scope.capture1': ('截图并复制 1', 'Capture & Copy 1'),
    'tool.tektronix_scope.capture2': ('截图并复制 2', 'Capture & Copy 2'),
    ...
    'tool.tektronix_scope.conn_none': ('未发现泰克示波器', 'No Tektronix scope found'),
