...
if __name__ == '__main__':
    sys.exit(
        'tools/generate_monitor_ui.py is deprecated: the UI layout has moved to '
        'monitor_window.ui (edit in Qt Designer). Theme preview is applied at runtime via theme.py.'
    )
